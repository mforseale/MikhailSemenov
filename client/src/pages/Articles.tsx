...
export default function Articles() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-20 py-20 gradient-bg">
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="text-4xl font-bold text-neutral-700 mb-4">Статьи и публикации</h1>
                  ...
                  <Card className="gradient-card border border-gray-100 card-hover cursor-pointer h-full"
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" className="text-primary hover:text-tek-blue-dark">
                          Читать полностью
                        </Button>
                      </div>
                    </CardContent>
